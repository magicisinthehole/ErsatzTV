...
public class UpdateChannelLegacyHandler : IRequestHandler<UpdateChannelLegacy, Either<BaseError, ChannelViewModel>>
{
    private readonly IDbContextFactory<TvContext> _dbContextFactory;
    private readonly ChannelWriter<ISubtitleWorkerRequest> _ffmpegWorkerChannel;

    public UpdateChannelLegacyHandler(
    ...
    private async Task<ChannelViewModel> ApplyUpdateRequest(TvContext dbContext, Channel c, UpdateChannelLegacy update)
    {
        c.Name = update.Name;
    ...
    private async Task<Validation<BaseError, Channel>> Validate(TvContext dbContext, UpdateChannelLegacy request) =>
    ...
    private static Task<Validation<BaseError, Channel>> ChannelMustExist(
        TvContext dbContext,
        UpdateChannelLegacy updateChannel) =>
        dbContext.Channels
            .Include(c => c.Artwork)
    ...
    private static Validation<BaseError, string> ValidateName(UpdateChannelLegacy updateChannel) =>
    ...
    private static Validation<BaseError, string> ValidatePreferredAudioLanguage(UpdateChannelLegacy updateChannel) =>
