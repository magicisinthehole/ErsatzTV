...
namespace ErsatzTV.Infrastructure.Migrations
{
    ...
    [Migration("20230107173145_Add_ChannelScheduleDayTemplate_Index")]
    partial class AddChannelScheduleDayTemplateIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Scheduling.ChannelScheduleDayTemplate", b =>
                {
                    b.Property<int>("ChannelId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ScheduleDayTemplateId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("ChannelId", "ScheduleDayTemplateId");

                    b.HasIndex("ScheduleDayTemplateId");

                    b.ToTable("ChannelScheduleDayTemplate", (string)null);
                });
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Scheduling.ScheduleDayTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ScheduleDayTemplate", (string)null);
                });

            modelBuilder.Entity("ErsatzTV.Core.Domain.Scheduling.ScheduleDayTemplateItem", b =>
                {
                    b.Property<int>("ScheduleDayTemplateId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("ScheduleDayTemplateId", "ScheduleBlockId");

                    b.HasIndex("ScheduleBlockId");

                    b.ToTable("ScheduleDayTemplateItem");
                });
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Scheduling.ChannelScheduleDayTemplate", b =>
                {
                    b.HasOne("ErsatzTV.Core.Domain.Channel", "Channel")
                        .WithMany("ChannelScheduleDayTemplates")
                        .HasForeignKey("ChannelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ErsatzTV.Core.Domain.Scheduling.ScheduleDayTemplate", "ScheduleDayTemplate")
                        .WithMany("ChannelScheduleDayTemplates")
                        .HasForeignKey("ScheduleDayTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Channel");

                    b.Navigation("ScheduleDayTemplate");
                });
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Channel", b =>
                {
                    ...
                    b.Navigation("ChannelScheduleDayTemplates");
